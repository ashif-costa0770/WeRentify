  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[10000] p-4">
      ...
      <div className="relative max-w-xl w-full bg-white rounded-3xl shadow-2xl p-8 animate-slideUp">
        ...
        <button
          onClick={onClose}
          className="absolute top-6 cursor-pointer right-6 text-gray-400 hover:text-gray-600"
        >
        ...
        <p className="text-gray-600 mb-8">
          Log in to start renting and earning
        </p>
        ...
        <div className="space-y-3">
          ...
          {/* Email */}
          <button className="w-full flex items-center cursor-pointer justify-center gap-3 px-4 py-3 border-2 border-gray-300 rounded-xl font-semibold text-gray-700 hover:bg-gray-50">
          ...
          {/* Google */}
          <button className="w-full flex cursor-pointer items-center justify-center gap-3 px-4 py-3 border-2 border-gray-300 rounded-xl font-semibold text-gray-700 hover:bg-gray-50">
          ...
          {/* Facebook */}
          <button className="w-full flex items-center cursor-pointer justify-center gap-3 px-4 py-3 rounded-xl font-semibold text-white bg-blue-600 hover:bg-blue-700">
          ...
          {/* Apple */}
          <button className="w-full flex cursor-pointer items-center justify-center gap-3 px-4 py-3 rounded-xl font-semibold text-white bg-black">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
