...
router.post("/", protect, uploadListingMedia, handleMulterError,  validate(createListingSchema), createListing);
router.get("/", getAllListings);
router.get("/:id", getListingById);
router.put("/:id",protect, uploadListingMedia, handleMulterError, validate(updateListingSchema),  updateListing);
